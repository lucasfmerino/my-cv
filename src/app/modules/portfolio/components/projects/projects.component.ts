...
export class ProjectsComponent {
  ...
  public projects: WritableSignal<IProjectDetails[]> = signal<IProjectDetails[]>([
    {
      src: '/assets/img/portfolio/heimd4ll.png',
      alt: 'Projeto Heimd4ll',
      title: 'Heimd4ll - Inteligência em Dados',
      width: '250',
      // height: '183px',
      description: '<p>Este projeto tem o objetivo de trazer funcionalidades que beneficiam a gestão da produçao e o controle de processos.</p> <p>Com esse sistema, é possível cadastrar os itens e seus roteiros de produção, gerar os romaneios de inspeção, ordens de produção e emitir relatórios.</p>',
      links: [
        {
    ...
    {
      src: '/assets/img/portfolio/project-heimd4ll2.png',
      alt: 'Projeto Heimd4ll',
      title: 'Heimd4ll - Inteligência em Dados',
      width: '250',
      // height: '183px',
